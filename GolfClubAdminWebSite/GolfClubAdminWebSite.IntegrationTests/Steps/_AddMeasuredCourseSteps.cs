...
namespace GolfClubAdminWebSite.IntegrationTests.Steps
{
    ...
    /*
    public class AddMeasuredCourseSteps_orig : GenericSteps
    {
        private readonly BrowserSession BrowserSession;

        public AddMeasuredCourseSteps(ScenarioContext scenarioContext, BrowserSession browserSession) : base(scenarioContext)
        {
